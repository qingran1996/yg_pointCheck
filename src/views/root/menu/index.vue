  ...
  <div class="domain">
    ...
    <el-card class="box-card" shadow="always">
      <el-table v-loading="loading" :data="tableData" ref="multipleTable" @selection-change="selectionchange"
        ...
        <el-table-column prop="path" show-overflow-tooltip label="菜单地址" min-width="200" align="center"/>
        <el-table-column prop="moduleCode" show-overflow-tooltip label="父级菜单" min-width="200" align="center"/>
    ...
    <vxe-modal v-model="showMenu" title="关联接口" width="60%" min-width="600"
