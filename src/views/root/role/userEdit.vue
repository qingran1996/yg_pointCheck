		 ...
		 :close-on-click-modal="false">
			...
			<el-form v-loading="loading" :label-position="'left'" label-width="80px" :model="sizeForm">
				...
				<div class="user_look_nav">
					<el-transfer v-model="value" :data="tableData" :titles="['可分配角色', '已分配角色']" :button-texts="['移除', '增加']" @change="deviceUpdateSure"
                       filterable :render-content="renderData"></el-transfer>
				</div>
			</el-form>
...
<script>
	export default {
        ...
        renderData:function(h,option) {
          //console.log(h(targetCreate,data,children:Array,text))
          return h('span',{domProps: {title: option.label,innerHTML:option.label}})
        },
				flag: false,
				listrole: [],
				config: {},
