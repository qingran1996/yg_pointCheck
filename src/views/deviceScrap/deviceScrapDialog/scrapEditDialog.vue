<template>
  <div class="editDialog">
    <el-dialog v-dialogDrag :close-on-click-modal="false" title="设备报废编辑" :visible.sync="editDialogVisible" width="30%" center>
      <el-form ref="ruleForm" :model="infoData" label-width="130px" class="demo-ruleForm">
        ...
        <el-form-item label="申请人" prop="applicant">
          <el-input v-model="infoData.applicant" />
        </el-form-item>
        <el-form-item label="申请时间" prop="createTime">
          <el-input v-model="infoData.createTime" />
        </el-form-item>
        <el-form-item label="申请部门" prop="dept">
          <el-input v-model="infoData.dept" />
        </el-form-item>
        <el-form-item label="申请原因" prop="reason">
          <el-input v-model="infoData.reason" />
        </el-form-item>
        ...
        <el-form-item v-if="ruleRadio===1" label="危险品迁址方案" prop="mainArgs">
          <el-input v-model="infoData.mainArgs" placeholder="危险品的处理方案"/>
        </el-form-item>
        ...
        <el-form-item label="审批人" prop="approve">
          <el-input v-model="infoData.approve" />
        </el-form-item>
      </el-form>
