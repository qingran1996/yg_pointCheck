    ...
    <el-card class="box-card" shadow="always">
      <el-col :span="18">
        <el-row style="margin-bottom: 5px;">
          <el-button type="success" :disabled="isDelete" @click="setServicePlan">配置保养计划</el-button>
        </el-row>
      ...
      <el-col :span="6">
        <div style="margin-left: 10px;">
          <el-row style="display: flex;justify-content: center;">
            <el-button type="danger" @click="deleteServicePlan" :disabled="planDelete" v-prevent-re-click>取消保养计划</el-button>
          </el-row>
