<template>
          ...
          <size-select id="size-select" class="right-menu-item hover-effect" />
			...
			<el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
				<div class="avatar-wrapper">
					...
					<img src="../../assets/user_images/222.jpg" class="user-avatar" >
					<!-- <img :src="imageUrl" class="user-avatar" v-if="!isHaveHead"> -->
					<span style="font-size: 15px;max-width: 100px;
    ...
    line-height: 15px;
    position: relative;
    top: 6px;"><span style="display: block;">欢迎，</span> {{user}}</span>
					<i class="el-icon-caret-bottom" style="display: inline-block;position: relative;top: -15px;" />
				</div>
